...
本文件通过 Codex 项目级安装进入 `.agents/skills/shared-references/agent-guide.md`。Leader 派生 Coder / Deployer / Writer 时，派生 agent 必须先读本文件。
...
Leader 负责派发。Executor 角色在任务中主动使用执行层 skills。
